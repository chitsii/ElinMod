// <auto-generated>
// Generated by generate_quest_data.py at 2026-01-05T17:11:08.431647
...
namespace Elin_SukutsuArena.Quests
{
    ...
    public static class ArenaNpcIds
    {
        ...
        public const string Astaroth = "sukutsu_grandmaster";
    }
    ...
    public static class ArenaQuestDatabase
    {
        ...
        private static void Initialize()
        {
            ...
            var q_02_first_battle = new ArenaQuestDefinition
            {
                QuestId = "02_first_battle",
                QuestType = ArenaQuestType.RankUp,
                DramaId = "first_battle",
                DisplayNameJP = "初戦",
                DisplayNameEN = "First Battle",
                Description = "最初の戦闘を行う",
                Phase = StoryPhase.Prologue,
            ...
            _quests["02_first_battle"] = q_02_first_battle;
            if (!_npcQuests.ContainsKey("sukutsu_receptionist"))
                _npcQuests["sukutsu_receptionist"] = new List<ArenaQuestDefinition>();
            _npcQuests["sukutsu_receptionist"].Add(q_02_first_battle);

            var q_03_rank_up_G = new ArenaQuestDefinition
            {
                QuestId = "03_rank_up_G",
                QuestType = ArenaQuestType.RankUp,
                DramaId = "rank_up_G",
                DisplayNameJP = "ランクG昇格試験",
                DisplayNameEN = "Rank G Promotion Trial",
                Description = "最初の試練を突破し、ランクGを獲得する",
                Phase = StoryPhase.Prologue,
                QuestGiver = "sukutsu_receptionist",
                AutoTrigger = false,
                AdvancesPhase = null,
                RequiredQuests = new List<string> { "02_first_battle" },
                Priority = 900
            };
            _quests["03_rank_up_G"] = q_03_rank_up_G;
            if (!_npcQuests.ContainsKey("sukutsu_receptionist"))
                _npcQuests["sukutsu_receptionist"] = new List<ArenaQuestDefinition>();
            _npcQuests["sukutsu_receptionist"].Add(q_03_rank_up_G);
            ...
            var q_04_rank_up_F = new ArenaQuestDefinition
            {
                ...
                RequiredQuests = new List<string> { "03_rank_up_G" },
                Priority = 900
            };
            _quests["04_rank_up_F"] = q_04_rank_up_F;
            if (!_npcQuests.ContainsKey("sukutsu_receptionist"))
                _npcQuests["sukutsu_receptionist"] = new List<ArenaQuestDefinition>();
            _npcQuests["sukutsu_receptionist"].Add(q_04_rank_up_F);

            var q_06_1_rank_up_E = new ArenaQuestDefinition
            {
                QuestId = "06_1_rank_up_E",
                QuestType = ArenaQuestType.RankUp,
                DramaId = "rank_up_E",
            ...
            var q_10_rank_up_D = new ArenaQuestDefinition
            {
                ...
                RequiredQuests = new List<string> { "06_1_rank_up_E" },
                Priority = 900
            };
            _quests["10_rank_up_D"] = q_10_rank_up_D;
            if (!_npcQuests.ContainsKey("sukutsu_receptionist"))
                _npcQuests["sukutsu_receptionist"] = new List<ArenaQuestDefinition>();
            _npcQuests["sukutsu_receptionist"].Add(q_10_rank_up_D);
            ...
            if (!_npcQuests.ContainsKey("sukutsu_receptionist"))
                _npcQuests["sukutsu_receptionist"] = new List<ArenaQuestDefinition>();
            _npcQuests["sukutsu_receptionist"].Add(q_11_rank_up_B);
            ...
            var q_12_rank_up_A = new ArenaQuestDefinition
            {
                ...
                AutoTrigger = false,
                AdvancesPhase = null,
                RequiredQuests = new List<string> { "11_rank_up_B", "13_makuma2" },
                Priority = 900
            };
            _quests["12_rank_up_A"] = q_12_rank_up_A;
            if (!_npcQuests.ContainsKey("sukutsu_receptionist"))
                _npcQuests["sukutsu_receptionist"] = new List<ArenaQuestDefinition>();
            _npcQuests["sukutsu_receptionist"].Add(q_12_rank_up_A);
            ...
            var q_15_vs_balgas = new ArenaQuestDefinition
            {
                ...
                QuestType = ArenaQuestType.RankUp,
                DramaId = "vs_balgas",
                DisplayNameJP = "ランクS昇格試験（バルガス全盛期との一騎打ち）",
                DisplayNameEN = "Rank S Promotion Trial (Duel with Prime Balgas)",
            ...
            var q_03_1_zek_intro = new ArenaQuestDefinition
            {
                QuestId = "03_1_zek_intro",
            ...
            var q_05_2_zek_steal_bottle = new ArenaQuestDefinition
            {
                ...
                DisplayNameJP = "ゼクの器すり替え提案",
                DisplayNameEN = "Zek's Bottle Swap Proposal",
            ...
            var q_06_2_zek_steal_soulgem = new ArenaQuestDefinition
            {
                ...
                DisplayNameJP = "カインの魂の選択",
                DisplayNameEN = "Kain's Soul Choice",
            ...
            var q_08_2_balgas_training = new ArenaQuestDefinition
            {
                QuestId = "08_2_balgas_training",
                QuestType = ArenaQuestType.CharacterEvent,
            ...
            _quests["08_2_balgas_training"] = q_08_2_balgas_training;
            if (!_npcQuests.ContainsKey("sukutsu_arena_master"))
                _npcQuests["sukutsu_arena_master"] = new List<ArenaQuestDefinition>();
            _npcQuests["sukutsu_arena_master"].Add(q_08_2_balgas_training);
            ...
            var q_16_lily_real_name = new ArenaQuestDefinition
            {
                ...
                AutoTrigger = false,
                AdvancesPhase = null,
                RequiredQuests = new List<string> { "15_vs_balgas" },
                Priority = 600
            };
            ...
            var q_17_escape = new ArenaQuestDefinition
            {
                QuestId = "17_escape",
                QuestType = ArenaQuestType.MainStory,
                DramaId = "vs_grandmaster_1",
            ...
            _quests["17_escape"] = q_17_escape;
            _autoTriggerQuests.Add(q_17_escape);
            ...
            var q_18_last_battle = new ArenaQuestDefinition
            {
                ...
                AutoTrigger = true,
                AdvancesPhase = null,
                RequiredQuests = new List<string> { "17_escape" },
                Priority = 1000
            };
