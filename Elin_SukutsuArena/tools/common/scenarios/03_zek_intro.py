...
def define_zek_intro(builder: DramaBuilder):
    ...
    builder.step(scene3) \
        ...
        .say("zek_5", "ああ、次なるランクF……『泥犬』への試練。そこには、あなたの体温を根こそぎ奪い去る『凍てつく魔物』が待ち構えている。", "", actor=zek) \
        .say("zek_6", "地上の安っぽい防具では、魂まで凍り付いてしまうでしょう。……ああ、想像できますよ。あなたが氷漬けになり、そのまま観客たちの冷笑の中で砕け散る様が。", "", actor=zek) \
        .say("zek_7", "どうでしょう、この薬……名は『万難のエリクサー』。飲めば血潮が沸き立ち、氷をも溶かす力を得られます。", "", actor=zek) \
        .say("zek_8", "……もっとも、引き換えに、あなたの『運命（カルマ）』を少しばかり消費することになりますが。命を落とす不条理に比べれば、安い対価だと思いませんか？", "", actor=zek)
