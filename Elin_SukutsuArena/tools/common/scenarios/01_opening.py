...
def define_opening_drama(builder: DramaBuilder):
    ...
    # リリィ登場（フォーカスにウェイト内蔵）
    builder.say("lily1", "……あら。召喚の儀も、空間の歪みもなしに、この『ヴォイド・コロシアム』に迷い込む『生きた肉』がいるなんて。", actor=lily) \
    ...
    # バルガス登場（フォーカスにウェイト内蔵）
    builder.say("vargus1", "これはこれは。ちょっとばかり魔物に追われて、運悪く次元の割れ目に滑り落ちた『迷い犬』か？", actor=vargus) \
