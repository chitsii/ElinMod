...
def define_lily_private(builder: DramaBuilder):
    ...
    builder.step(scene3) \
        ...
        .say("narr_12", "（あなたは彼女の吐息に、甘美でありながら危険な「何か」を感じ取る。ーーそれは、捕食者の本能。）", "", actor=pc) \
        .shake() \
        .say("lily_14", "……ふふ、冗談よ。", "", actor=lily) \
        .say("narr_13", "（彼女は一歩下がるが、その手は微かに震えている。）", "", actor=pc) \
        .say("lily_mono1", "（……だめよ。この人に手をだしてはいけない。）", "", actor=lily) \
    ...
    builder.step(scene4) \
        ...
        .say("lily_17", "……ふふ、先程の質問の答えは、またどこかで聞かせてもらうことにしましょう。", "", actor=lily) \
