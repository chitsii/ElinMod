...
def define_last_battle(builder: DramaBuilder):
    ...
    astaroth = builder.register_actor("sukutsu_grandmaster", "アスタロト", "Astaroth")
    ...
    builder.step(act2) \
        ...
        .focus_chara("sukutsu_grandmaster") \
