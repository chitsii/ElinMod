...
namespace Elin_ItemRelocator {
    public static class RelocatorLang {
        ...
        private static Dictionary<LangKey, string[]> _dict = new() {
            ...
            [LangKey.EditCategoryID] = ["Edit Category ID", "カテゴリID編集"],
            [LangKey.EditQuality] = ["Edit Quality (e.g. >=2)", "品質設定 (例: >=2)"],
            ...
            [LangKey.SavePreset] = ["Save Preset", "プリセット保存"],
            [LangKey.LoadPreset] = ["Load Preset", "プリセット読込"],
